...
const Products = () => {
  const features = [
    ...
    "100% японски произход от Uji, Киото",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-muted-foreground">
            Премиум японска матча, създадена с почит към традицията и любов към детайла
          </p>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
                ...
                <CardHeader className="space-y-4 pb-6">
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground">
                      Традиционна японска церемониална матча от Киото
                    </p>
                  </div>
                </CardHeader>
          ...
          <div className="mt-12 text-center p-8 bg-card rounded-xl shadow-soft border border-border">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Ако не си доволна от SEIJAKU в рамките на 30 дни, 
