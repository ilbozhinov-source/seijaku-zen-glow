      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg md:text-xl text-muted-foreground">
            100% японска церемониална матча, ръчно смляна с любов и внимание към всеки детайл.
            Създадена за модерната жена, която търси баланс между динамичния живот и вътрешното спокойствие.
          </p>
        </div>
